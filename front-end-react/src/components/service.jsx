                ...
                <div className="bg-base-200 p-6 rounded-lg">
                    <div className="px-7 sm:px-4">
                        ...
                        <div className="mt-4">
                            ...
                            <div className="join w-full h-10 bg-white border mt-1 border-gray-300 flex items-center justify-between">
                                ...
                                <input
                                    ...
                                    disabled
                                />
                                    <label className="btn bg-green-500 hover:bg-green-600 h-8 text-white btn-xs sm:btn-xs md:btn-xs lg:btn-xs cursor-pointer flex items-center">
